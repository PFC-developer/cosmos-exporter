...
func NewExchangeRateTuple(denom string, exchangeRate cosmos_math.LegacyDec) ExchangeRateTuple {
...
func NewDenomOracleExchangeRatePair(denom string, exchangeRate cosmos_math.LegacyDec, lastUpdate cosmos_math.Int, lastUpdateTimestamp int64) DenomOracleExchangeRatePair {
